...
public class Routes {
    //    ``````````````````` ``````````````````````````````domain````````````````````````
    public static final String domain = "https://logisticsfed.com/";
    //    -----------------------------------------------insideroot----------------------------------------------
    public static final String controller = domain + "backend/controller/api/";
    ...
    public static final String insert = common + "insert";
    public static final String insert2 = common + "insert2";
    ...
    public static final String neworder = common + "neworder";
    ...
    public static final String selectOneByColumn = common + "selectOneByColumn";
